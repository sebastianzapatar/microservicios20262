 ...
 * construida a partir de los eventos "historial.*" que llegan por RabbitMQ.
 *
 ...
 * pacientes-service pueda responder sin preguntarle a nadie, aunque el otro
 * microservicio esté caído. El precio es la consistencia eventual: entre que
 * se crea un historial y que aparece aquí pasan unos milisegundos.
 *
 * El id es el _id de MongoDB del historial, así que reprocesar un evento
 * sobrescribe la fila en lugar de duplicarla (la operación es idempotente).
 */
@Entity
